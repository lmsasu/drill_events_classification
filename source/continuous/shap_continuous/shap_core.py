...
def plot_heatmap(
    ...
    """Heatmap of mean |SHAP| across time steps x features.
    ...
    ax.set_title("SHAP - time step x feature  (mean |SHAP| across samples & classes)")
...
def write_report(
    ...
    lines += [
        ...
        "| `shap_heatmap.png` | Heatmap - mean \\|SHAP\\| per time step x feature, "
