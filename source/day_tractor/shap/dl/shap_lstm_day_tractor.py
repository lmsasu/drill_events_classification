"""
SHAP feature-importance analysis for the best LSTM trial.
...
from day_tractor.dl.train_lstm_day_tractor import LSTMClassifier
...
ALL_RESULTS    = RESULTS_DIR  / "all_results_lstm.xlsx"
N_BACKGROUND   = 100
N_TEST_SAMPLES = 300
...
def main() -> None:
    ...
    ckpt = RESULTS_DIR / f"results_lstm_{timestamp}" / "best_model.pt"
