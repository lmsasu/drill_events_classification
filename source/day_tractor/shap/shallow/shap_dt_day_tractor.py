"""
SHAP feature-importance analysis for the best Decision Tree trial.
...
ALL_RESULTS = RESULTS_DIR  / "all_results_dt.xlsx"
...
def main() -> None:
    ...
    model = DecisionTreeClassifier(
        ...
        criterion    = nullable_str(row.get("criterion")) or "gini",
        max_features = nullable_str(row.get("max_features")),
